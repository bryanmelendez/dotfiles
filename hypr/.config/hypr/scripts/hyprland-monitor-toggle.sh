...
# https://gist.github.com/miyl/7c4ebc95c5a02f84f36a769a3690cde6
...
INTERNAL_SCALING="2"
INTERNAL_SPECS="2880x1800@90"

EXTERNAL_MONITOR="DP-3"
EXTERNAL_SCALING="1"
EXTERNAL_SPECS="1920x1080@120"

# hyprctl keyword monitor "$EXTERNAL_MONITOR,$EXTERNAL_SPECS,0x0,$EXTERNAL_SCALING"
# hyprctl keyword monitor "$INTERNAL_MONITOR,$INTERNAL_SPECS,0x0,$INTERNAL_SCALING"
